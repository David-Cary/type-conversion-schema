...
exports.ToArrayConvertor = exports.DEFAULT_ARRAY_ACTIONS = exports.DeleteArrayItemAction = exports.InsertArrayItemAction = exports.ParseArrayStringAction = exports.CopyArrayAction = void 0;
    ...
    transform(value, options) {
        if (typeof value === 'string') {
            try {
                ...
                return (0, conversions_1.getArrayFrom)(parsed);
            }
            catch (error) {
                return [value];
            }
        }
        return (0, conversions_1.getArrayFrom)(value);
    }
}
...
class ToArrayConvertor extends actions_1.TypedActionsValueConvertor {
    constructor(actions = exports.DEFAULT_ARRAY_ACTIONS) {
        super('object', conversions_1.getArrayFrom, actions);
    }
