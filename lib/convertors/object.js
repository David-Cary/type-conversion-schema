...
class SetObjectPropertyAction extends DeleteObjectValueAction {
    transform(value, options, resolver) {
        if (options != null && 'path' in options) {
            const path = Array.isArray(options.path) ? options.path : [options.path];
            if (path.length > 0) {
