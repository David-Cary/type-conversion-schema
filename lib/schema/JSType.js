...
exports.createBasicSchema = exports.getExtendedTypeOf = exports.getTypedValueRecord = exports.getTypedArray = exports.initTypedJSONSchema = exports.initJSONSchema = exports.JSTypeToJSONSchema = exports.JSON_SCHEMA_TYPE_NAMES = exports.JSTypeName = void 0;
var JSTypeName;
(function (JSTypeName) {
    JSTypeName["ANY"] = "any";
...
function initJSONSchema(source, schema) {
    ...
    if (source.definitions != null) {
        schema.definitions = getTypedValueRecord(source.definitions, item => JSTypeToJSONSchema(item));
    }
}
