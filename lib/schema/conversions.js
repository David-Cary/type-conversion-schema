...
class InterfaceEnforcer {
    ...
    applyTo(value, resolver, context) {
        const result = resolver.convert(value, this.schema, context);
        return result;
    }
}
exports.InterfaceEnforcer = InterfaceEnforcer;
