...
const json_schema_typed_1 = require("json-schema-typed");
class TypeConversionResolver {
    ...
    getJSONSchema(source) {
        const typeNames = Object.values(json_schema_typed_1.TypeName);
        const schema = this.getExpandedSchema(source, typeNames);
